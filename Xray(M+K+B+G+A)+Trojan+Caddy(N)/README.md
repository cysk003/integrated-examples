...
14、若现有 Nginx 网站或大型网站或需要 NaiveProxy 支持 HTTP/3 代理应用，推荐采用 [Xray(M+K+B+G+A)+Trojan+Caddy(N)+Nginx\HAProxy](https://github.com/lxhao61/integrated-examples/tree/main/Xray(M%2BK%2BB%2BG%2BA)%2BTrojan%2BCaddy(N)%2BNginx%5CHAProxy) 示例。
